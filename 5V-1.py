...
logo = (""""\033[132mAsib king
\033[1;32m \033[1;32md8888b. d88888b db    db d888888b db      
\033[1;32m 88  `8D 88'     88    88   `88'   88      
\033[1;32m 88   88 88ooooo Y8    8P    88    88      
\033[1;32m 88   88 88~~~~~ `8b  d8'    88    88      
\033[1;32m 88  .8D 88.      `8bd8'    .88.   88booo. 
\033[1;32m Y8888D' Y88888P    YP    Y888888P Y88888P ")
def ud():
    os.system('clear')
    jalan(logo)
...
def o():
    ...
    if opt == '1':
        i()
    if opt == '2':
        os.system('xdg-open https://www.facebook.com/profile.php?id=100092682300231')
        return None
    if opt == '3':
        os.system('xdg-open https://youtube.com/@onlinjob?si=SGyo1rP4NdRD2jVQ')
        return None
    if opt == '4':
        os.system('https://www.facebook.com/profile.php?id=100092682300231')
...
today = date.today()
logo = ("""\033[132m🅁①🄵④🅃
\033[1;32 md8888b. d88888b db    db d888888b db      
\033[1;3288  `8D 88'     88    88   `88'   88      
\033[1;3288   88 88ooooo Y8    8P    88    88      
\033[1;3288   88 88~~~~~ `8b  d8'    88    88      
\033[1;3288  .8D 88.      `8bd8'    .88.   88booo. 
\033[1;32 Y8888D' Y88888P    YP    Y888888P Y88888P 
